...
# Purpose:     Useful for downloaded data from ArcGIS Online Feature Services that have
#              a pre-existing feature class in a production environment. With some
#              modification method, it can be used to aggregate different feature classes with attachments
# Author:      ben nadler
#
# Created:     07/05/2015
...
#-------------------------------------------------------------------------------
# Revised by: Ahjung Kim
# Purpose:     -Origin script has been modified to accept parameters from script tool
...
def main():
    ...
    updateFeatureClass = arcpy.GetParameterAsText(0)
    # targetFeatureClass = r'C:\Temp\TEST\Target.gdb\Orig'
    targetFeatureClass = arcpy.GetParameterAsText(1)
